...
void HeatEq::HeatVec::elementalComputVec(const VECType* in, VECType* out,
...
bool HeatEq::HeatVec::preComputeVec(const VECType* in, VECType* out,
                                    double scale) {
...
bool HeatEq::HeatVec::postComputeVec(const VECType* in, VECType* out,
                                     double scale) {
    // apply boundary conditions.
    std::vector<unsigned int> bdyIndex;
    std::vector<double> bdyCoords;
