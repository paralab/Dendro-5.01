...
const BHA_REAL NOSIMDCFL_FACTOR = commondata->CFL_FACTOR;                            // nrpy.infrastructures.BHaH.MoLtimestepping.register_all::CFL_FACTOR
...
const BHA_REAL NOSIMDdt = commondata->dt;                                            // nrpy.infrastructures.BHaH.MoLtimestepping.register_all::dt
MAYBE_UNUSED const REAL_SIMD_ARRAY dt = ConstSIMD(NOSIMDdt);                     // nrpy.infrastructures.BHaH.MoLtimestepping.register_all::dt
const BHA_REAL NOSIMDdxx0 = params->dxx0;                                            // nrpy.infrastructures.BHaH.BHaHAHA.numgrid__evol_set_up::dxx0
MAYBE_UNUSED const REAL_SIMD_ARRAY dxx0 = ConstSIMD(NOSIMDdxx0);                 // nrpy.infrastructures.BHaH.BHaHAHA.numgrid__evol_set_up::dxx0
const BHA_REAL NOSIMDdxx1 = params->dxx1;                                            // nrpy.infrastructures.BHaH.BHaHAHA.numgrid__evol_set_up::dxx1
MAYBE_UNUSED const REAL_SIMD_ARRAY dxx1 = ConstSIMD(NOSIMDdxx1);                 // nrpy.infrastructures.BHaH.BHaHAHA.numgrid__evol_set_up::dxx1
const BHA_REAL NOSIMDdxx2 = params->dxx2;                                            // nrpy.infrastructures.BHaH.BHaHAHA.numgrid__evol_set_up::dxx2
MAYBE_UNUSED const REAL_SIMD_ARRAY dxx2 = ConstSIMD(NOSIMDdxx2);                 // nrpy.infrastructures.BHaH.BHaHAHA.numgrid__evol_set_up::dxx2
const BHA_REAL NOSIMDeta_damping = commondata->eta_damping;                          // nrpy.infrastructures.BHaH.BHaHAHA.rhs_eval_KO_apply::eta_damping
...
const BHA_REAL NOSIMDinterp_src_dxx0 = commondata->interp_src_dxx0; // nrpy.infrastructures.BHaH.BHaHAHA.numgrid__interp_src_set_up::interp_src_dxx0
...
const BHA_REAL NOSIMDinterp_src_dxx1 = commondata->interp_src_dxx1; // nrpy.infrastructures.BHaH.BHaHAHA.numgrid__interp_src_set_up::interp_src_dxx1
...
const BHA_REAL NOSIMDinterp_src_dxx2 = commondata->interp_src_dxx2; // nrpy.infrastructures.BHaH.BHaHAHA.numgrid__interp_src_set_up::interp_src_dxx2
...
const BHA_REAL NOSIMDinvdxx0 = params->invdxx0;    // nrpy.infrastructures.BHaH.BHaHAHA.numgrid__evol_set_up::invdxx0
...
const BHA_REAL NOSIMDinvdxx1 = params->invdxx1;                            // nrpy.infrastructures.BHaH.BHaHAHA.numgrid__evol_set_up::invdxx1
...
const BHA_REAL NOSIMDinvdxx2 = params->invdxx2;                            // nrpy.infrastructures.BHaH.BHaHAHA.numgrid__evol_set_up::invdxx2
...
const BHA_REAL NOSIMDKO_diss_strength = commondata->KO_diss_strength;      // nrpy.infrastructures.BHaH.BHaHAHA.rhs_eval_KO_apply::KO_diss_strength
...
const BHA_REAL NOSIMDt_0 = commondata->t_0;                                // nrpy.infrastructures.BHaH.MoLtimestepping.register_all::t_0
MAYBE_UNUSED const REAL_SIMD_ARRAY t_0 = ConstSIMD(NOSIMDt_0);         // nrpy.infrastructures.BHaH.MoLtimestepping.register_all::t_0
const BHA_REAL NOSIMDt_final = commondata->t_final;                        // nrpy.infrastructures.BHaH.MoLtimestepping.register_all::t_final
...
const BHA_REAL NOSIMDtime = commondata->time;                              // nrpy.infrastructures.BHaH.MoLtimestepping.register_all::time
