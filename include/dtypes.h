...
/**
@brief A template specialization of the abstract class Mpi_datatype. This can be
used for communicating messages of type "bool"
...
class Mpi_datatype<bool> {
   ...
   public:
    /**
      @brief User defined MPI_Operation to perform: second[i] = (first[i] &&
     second[i]),
      @remark first and second are 2 arrays of type bool and '&&' represents the
