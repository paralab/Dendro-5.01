...
class Node : public ot::TreeNode {
   ...
   public:
    ...
    Node(unsigned int px, unsigned int py, unsigned int pz, unsigned int plevel,
         unsigned int pDim,
         unsigned int
...
communicating messages of type "ot::Node".
*/
template <>
class Mpi_datatype<ot::Node> {
    ...
    //        }//end function
    //
    //        static void Node_MAX(void *in, void *inout, int* len, MPI_Datatype
    //        * dptr) {
    //            for(int i = 0; i < (*len); i++) {
    //                ot::TreeNode first = (static_cast<ot::TreeNode*>(in))[i];
    //                ot::TreeNode second =
    //                (static_cast<ot::TreeNode*>(inout))[i];
    //                (static_cast<ot::TreeNode*>(inout))[i] = ( ( first >
    //                second )? first : second );
    //            }//end for
    //        }//end function
    //
    //        static void Node_MIN(void *in, void *inout, int* len, MPI_Datatype
    //        * dptr) {
    //            for(int i = 0; i < (*len); i++) {
    //                ot::TreeNode first = (static_cast<ot::TreeNode*>(in))[i];
    //                ot::TreeNode second =
    ...
    //        }//end function
    //
    //        /* static void Node_NCA(void *in, void *inout, int* len,
    //        MPI_Datatype * dptr) {
    //             for(int i = 0; i < (*len); i++) {
    //                 ot::TreeNode first = (static_cast<ot::TreeNode*>(in))[i];
    //                 ot::TreeNode second =
    //                 (static_cast<ot::TreeNode*>(inout))[i]; if( first !=
    //                 second ) {
    //                     (static_cast<ot::TreeNode*>(inout))[i] =
    //                     ot::getNCA(first, second);
    //                 }//end if
    //             }//end for
    //         }//end function*/
    ...
    **/
    ...
    //            if (first) {
    //                first = false;
    //                MPI_Op_create(Mpi_datatype<ot::TreeNode>::Node_MAX ,true
    //                ,&max);
    //            }
    //            return max;
    //        }
    ...
    **/
    ...
    //            if (first) {
    //                first = false;
    //                MPI_Op_create(Mpi_datatype<ot::TreeNode>::Node_MIN ,true
    //                ,&min);
    //            }
    //            return min;
    //        }
