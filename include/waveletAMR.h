...
/**
 * @brief Computes the wavelet coefficient for a specified element (unzip)
 * vector
 * @tparam T : data type.
...
/**
 * @brief Compute the remesh flags of the entire mesh looping over local
 * partition.
 *
...
bool compute_wavelet_remesh_flags(
    ...
    double amr_coarse_fac = DENDRO_AMR_COARSEN_FAC, bool includeBdy = false);
