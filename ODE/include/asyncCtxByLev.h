 ...
 * @brief Asynchronous communication for non uniform time stepper. This class is
 * derived from the asyncExchangeContext.h to support partial ghost sync.
 * @version 0.1
 * @date 2020-01-16
 *
...
class AsyncCommByLev : public ot::AsyncExchangeContex {
   ...
   public:
    ...
    bool operator==(const AsyncCommByLev& other) {
        return (this->m_uiBuffer == other.m_uiBuffer &&
                m_uiLev == other.m_uiLev);
    }
