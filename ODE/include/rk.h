...
class RK {
   protected:
    /** pointer for geometric grid (the grid generated by tree construction and
     * balancing)*/
    ot::Mesh* m_uiMesh;
   ...
   public:
    ...
    // inline void setCurrentTimeStep(unsigned int step) {
    //     m_uiCurrentStep = step;
    // }
    /** set the current time value */
    // inline void setCurrentTimeValue(double tValue) { m_uiCurrentTime =
    // tValue; }
