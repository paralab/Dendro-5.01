...
*@brief rk4 solver for quadgrav equations.
*/
//

#ifndef SFCSORTBENCH_RK4QUADGRAV_H
#define SFCSORTBENCH_RK4QUADGRAV_H
...
namespace ode
{
    namespace solver
    {
        ...
        class RK4_QUADGRAV : public RK
        {

        private:

            // variables for QUADGRAV formulation.
        ...
        public:
             ...
             * * */
            RK4_QUADGRAV(ot::Mesh *pMesh, double pTBegin, double pTEnd,double pTh);
...
#endif //SFCSORTBENCH_RK4QUADGRAV_H
