...
def sym_3x3(name, idx):
    ...
    m1, m2, m3, m4, m5, m6, m7, m8, m9, m10, m11, m12, m13, m14, m15, m16, m17, m18, m19, m20, m21, m22, m23, m24, m25, m26, m27 = symbols(vname)
    
    return Matrix([[m1, m2, m3], [m2, m4, m5], [m3, m5, m6]])

def ten_3x3x3(name, idx):
    """
    Create a tensor 3x3x3 matrix variables with the corresponding name. The 'name' will be during code generation, so
    should match the variable name used in the C++ code. The returned variable can be indexed(0,1,2)^2, i.e.,

    gt = dendro.sym_3x3x3("gt")
    gt[0,2,0] = x^2
    """
