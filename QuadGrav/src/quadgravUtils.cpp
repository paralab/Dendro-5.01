...
namespace quadgrav
{
    ...
    void readParamFile(const char * fName,MPI_Comm comm)
    {
        ...
        if(!rank)
        {
            ...
            quadgrav::QUADGRAV_RK45_TIME_BEGIN=parFile["QUADGRAV_RK45_TIME_BEGIN"];
            quadgrav::QUADGRAV_RK45_TIME_END=parFile["QUADGRAV_RK45_TIME_END"];
            ...
            quadgrav::QUADGRAV_ID_AMP1=parFile["QUADGRAV_ID_AMP1"];
            quadgrav::QUADGRAV_ID_AMP2=parFile["QUADGRAV_ID_AMP2"];
            quadgrav::QUADGRAV_ID_DELTA1=parFile["QUADGRAV_ID_DELTA1"];
            quadgrav::QUADGRAV_ID_DELTA2=parFile["QUADGRAV_ID_DELTA2"];
            quadgrav::QUADGRAV_ID_XC1=parFile["QUADGRAV_ID_XC1"];
            quadgrav::QUADGRAV_ID_YC1=parFile["QUADGRAV_ID_YC1"];
            quadgrav::QUADGRAV_ID_ZC1=parFile["QUADGRAV_ID_ZC1"];
            ...
            quadgrav::QUADGRAV_ID_NU2=parFile["QUADGRAV_ID_NU2"];
            quadgrav::QUADGRAV_ID_OMEGA=parFile["QUADGRAV_ID_OMEGA"];
        ...
        par::Mpi_Bcast(&QUADGRAV_RK45_TIME_BEGIN,1,0,comm);
        par::Mpi_Bcast(&QUADGRAV_RK45_TIME_END,1,0,comm);
        ...
        par::Mpi_Bcast(&QUADGRAV_ID_AMP1,1,0,comm);
        par::Mpi_Bcast(&QUADGRAV_ID_AMP2,1,0,comm);
        par::Mpi_Bcast(&QUADGRAV_ID_DELTA1,1,0,comm);
        par::Mpi_Bcast(&QUADGRAV_ID_DELTA2,1,0,comm);
        par::Mpi_Bcast(&QUADGRAV_ID_XC1,1,0,comm);
        par::Mpi_Bcast(&QUADGRAV_ID_YC1,1,0,comm);
        par::Mpi_Bcast(&QUADGRAV_ID_ZC1,1,0,comm);
        ...
        par::Mpi_Bcast(&QUADGRAV_ID_NU2,1,0,comm);
        par::Mpi_Bcast(&QUADGRAV_ID_OMEGA,1,0,comm);
    ...
    void initData(const double xx1,const double yy1,const double zz1, double *var)
    {
        ...
        const double amp1 = quadgrav::QUADGRAV_ID_AMP1;
        const double amp2 = quadgrav::QUADGRAV_ID_AMP2;
        const double delta1 = quadgrav::QUADGRAV_ID_DELTA1;
        const double delta2 = quadgrav::QUADGRAV_ID_DELTA2;
        const double xc1 = quadgrav::QUADGRAV_ID_XC1;
        const double yc1 = quadgrav::QUADGRAV_ID_YC1;
        const double zc1 = quadgrav::QUADGRAV_ID_ZC1;
        const double xc2 = quadgrav::QUADGRAV_ID_XC2;
        const double yc2 = quadgrav::QUADGRAV_ID_YC2;
        ...
        const double nu2 = quadgrav::QUADGRAV_ID_NU2;
        const double Omega = quadgrav::QUADGRAV_ID_OMEGA;
    ...
    {
       return quadgrav::QUADGRAV_WAVELET_TOL;
    }
